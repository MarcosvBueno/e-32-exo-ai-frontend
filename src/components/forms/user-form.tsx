            ...
            {hasDetectedExoplanet ? null : (
              <div className="flex w-full flex-col items-center  gap-6 lg:max-w-xl px-4">
                ...
                <form
                  ...
                  className="grid grid-cols-1 sm:grid-cols-2 gap-6 rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 shadow-2xl backdrop-blur w-full"
                >
                  {getFieldConfigs(t).map(field => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 min-h-[2rem] xl:min-h-[2.25rem]">
                          <Label
                            htmlFor={field.name as string}
                            className="text-[10px] xl:text-xs 2xl:text-xs font-semibold uppercase tracking-[0.28em] text-cyan-200 flex items-end"
                          >
                            {field.label}
                          </Label>
                          <PopoverInfoForm
